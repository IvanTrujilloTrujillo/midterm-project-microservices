...
import com.ironhack.accountservice.service.interfaces.ICreditCardService;
...
public class CreditCardService implements ICreditCardService {
    ...
    public CreditCardDTO createCreditCard(CreditCardDTO creditCardDTO) {
        ...
        CreditCard creditCard = new CreditCard(creditCardDTO.getBalance(), creditCardDTO.getPrimaryOwner(),
                creditCardDTO.getSecondaryOwner(), creditCardDTO.getCreditLimit(), creditCardDTO.getInterestRate());
