...
public class Saving extends Account{
     ...
     **/
    public Saving(Money balance, Long primaryOwner, Long secondaryOwner, String secretKey, Money minimumBalance, BigDecimal interestRate) {
     ...
     **/
    public Saving(Money balance, Long primaryOwner, Long secondaryOwner, String secretKey, Money minimumBalance) {
        super(balance, primaryOwner, secondaryOwner);
        setSecretKey(secretKey);
        //If the minimum balance isn't a valid value, throws an exception and put the default value
        try {
     ...
     **/
    public Saving(Money balance, Long primaryOwner, Long secondaryOwner, String secretKey, BigDecimal interestRate) {
        super(balance, primaryOwner, secondaryOwner);
        setSecretKey(secretKey);
     ...
     **/
    public Saving(Money balance, Long primaryOwner, Long secondaryOwner, String secretKey) {
        super(balance, primaryOwner, secondaryOwner);
        setSecretKey(secretKey);
        //Set minimum balance on default value
        setMinimumBalance(new Money(BigDecimal.valueOf(1000), balance.getCurrency()));
     ...
     **/
    public Saving(Money balance, Long primaryOwner, String secretKey, Money minimumBalance, BigDecimal interestRate) {
     ...
     **/
    public Saving(Money balance, Long primaryOwner, String secretKey, Money minimumBalance) {
        super(balance, primaryOwner);
        setSecretKey(secretKey);
        //If the minimum balance isn't a valid value, throws an exception and put the default value
        try {
     ...
     **/
    public Saving(Money balance, Long primaryOwner, String secretKey, BigDecimal interestRate) {
        super(balance, primaryOwner);
        setSecretKey(secretKey);
        //Set minimum balance on default value
        setMinimumBalance(new Money(BigDecimal.valueOf(1000), balance.getCurrency()));
     ...
     **/
    public Saving(Money balance, Long primaryOwner, String secretKey) {
        super(balance, primaryOwner);
        setSecretKey(secretKey);
        //Set minimum balance on default value
        setMinimumBalance(new Money(BigDecimal.valueOf(1000), balance.getCurrency()));
