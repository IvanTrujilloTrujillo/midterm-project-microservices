...
public class CreditCard extends Account{
     ...
     **/
    public CreditCard(Money balance, Long primaryOwner, Long secondaryOwner, Money creditLimit, BigDecimal interestRate) {
     ...
     **/
    public CreditCard(Money balance, Long primaryOwner, Long secondaryOwner, Money creditLimit) {
        super(balance, primaryOwner, secondaryOwner);
        //If the credit limit isn't a valid value, throws an exception and put the default value
        try {
            setCreditLimit(creditLimit);
     ...
     **/
    public CreditCard(Money balance, Long primaryOwner, Long secondaryOwner, BigDecimal interestRate) {
        super(balance, primaryOwner, secondaryOwner);
     ...
     **/
    public CreditCard(Money balance, Long primaryOwner, Long secondaryOwner) {
        super(balance, primaryOwner, secondaryOwner);
        //Set credit limit on default value
        setCreditLimit(new Money(BigDecimal.valueOf(100), balance.getCurrency()));
        //Set interest rate on default value
     ...
     **/
    public CreditCard(Money balance, Long primaryOwner, Money creditLimit, BigDecimal interestRate) {
     ...
     **/
    public CreditCard(Money balance, Long primaryOwner, Money creditLimit) {
        super(balance, primaryOwner);
        //If the credit limit isn't a valid value, throws an exception and put the default value
        try {
            setCreditLimit(creditLimit);
     ...
     **/
    public CreditCard(Money balance, Long primaryOwner, BigDecimal interestRate) {
        super(balance, primaryOwner);
        //Set credit limit on default value
        setCreditLimit(new Money(BigDecimal.valueOf(100), balance.getCurrency()));
        //If the interest rate isn't a valid value, throws an exception and put the default value
     ...
     **/
    public CreditCard(Money balance, Long primaryOwner) {
        super(balance, primaryOwner);
        //Set credit limit on default value
        setCreditLimit(new Money(BigDecimal.valueOf(100), balance.getCurrency()));
        //Set interest rate on default value
